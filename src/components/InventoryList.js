...
const InventoryList = ({ onNewPurchaseClick }) => {
  ...
  formatDate(purchase.purchaseDate).toLowerCase().includes(searchQuery.toLowerCase())
  );
        ...
        <html>
          ...
          <div style=" display: flex;justify-content: center;">
            <div class="popup-content">
              ...
              <div  style="display: flex; flex-direction: row; margin-bottom: -10px;"> <p class="popup-details">Purchase Date</p> :&nbsp;&nbsp;&nbsp;&nbsp; ${selectedItem.purchaseDate} </div>
              <div  style="display: flex; flex-direction: row; margin-bottom: -10px;"> <p class="popup-details">Supplier</p> : &nbsp;&nbsp;&nbsp;&nbsp;${selectedItem.supplier} </div>
              <div  style="display: flex; flex-direction: row; margin-bottom: -10px;"> <p class="popup-details">Bill Number</p> : &nbsp;&nbsp;&nbsp;&nbsp;${selectedItem.billNumber} </div>
              <div  style="display: flex; flex-direction: row; margin-bottom: -10px;"> <p class="popup-details">Purchase Type</p> : &nbsp;&nbsp;&nbsp;&nbsp;${selectedItem.purchaseType} </div>
              <div  style="display: flex; flex-direction: row; margin-bottom: -10px;"> <p class="popup-details">Purchase Amount</p> : &nbsp;&nbsp;&nbsp;&nbsp;₹ ${selectedItem.totalPurchaseAmount} </div>
              <div  style="display: flex; flex-direction: row; margin-bottom: -10px;">  <p class="popup-details">No of Products</p> : &nbsp;&nbsp;&nbsp;&nbsp;${selectedItem.NoOfProducts} </div>
  ...
  <div className="popup-overlay">
    <div className="popup-content">
      <div className="flexchange445577"><h5 className="popup-title">Purchase Order Details</h5>
      <button className="popup-close-button" onClick={() => setSelectedItem(null)}>X</button></div>
      <div className="flexchange4455"><p className="popup-details">Purchase Date</p> : &nbsp; &nbsp; &nbsp;{selectedItem.purchaseDate}</div>
      <div className="flexchange4455"> <p className="popup-details">Supplier </p>: &nbsp; &nbsp; &nbsp;{selectedItem.supplier}</div>
      <div className="flexchange4455"><p className="popup-details">Bill Number</p> : &nbsp; &nbsp; &nbsp;{selectedItem.billNumber}</div>
      <div className="flexchange4455"><p className="popup-details">Purchase Type</p> : &nbsp; &nbsp; &nbsp;{selectedItem.purchaseType}</div>
      <div className="flexchange4455"><p className="popup-details">Purchase Amount</p> : &nbsp; &nbsp; &nbsp;₹ {selectedItem.totalPurchaseAmount}</div>
      <div className="flexchange4455"><p className="popup-details">No of Products</p> : &nbsp; &nbsp; &nbsp;{selectedItem.NoOfProducts}</div>
      ...
      <button className="popup-print-button" onClick={handlePrint}>Print</button>
      </div>
    </div>
  </div>
)}
