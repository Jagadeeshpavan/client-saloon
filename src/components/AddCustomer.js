...
//       // Send the form data to the backend
//       const response = await axios.post(
//         "${BASE_URL}/api/profiles", // Update the URL to match your backend API endpoint
//         formDataToSubmit,
//         {
//           headers: {
//             "Content-Type": "multipart/form-data",
...
//   const formbody = {
//     // backgroundImage: 'url("${BASE_URL}/resources/images/article_assets/2014/02/Feb14_02_108315569.jpg")'
